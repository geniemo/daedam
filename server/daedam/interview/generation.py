...
#: 인성 6개의 근거는 실측이다. full 프로필(인성 6분)에서 4개가 55초꼴로
#: 소진돼 마무리로 2분 일찍 넘어갔다(13분 면접, 2026-09-02). 문항당 ~1분이면
#: 6분 예산에 6개가 맞다. 직무는 시간 경과 이동이 먼저 와서(5개 중 4개 소화)
#: 그대로 둔다.
_TARGET_COUNTS = {1: 5, 2: 6}

#: 단계별 최소 개수 — 실전에서 나가는 수. 이보다 적으면 생성 실패로 본다.
_MINIMUM_COUNTS = {1: 3, 2: 3}
